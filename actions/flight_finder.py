...
from core.llm.helpers import LegacyLLMModel, llm_complete
...
def _parse_flights_with_gemini(
    ...
    try:
        text = re.sub(r"```(?:json)?", "", llm_complete(prompt, system=system)).strip().rstrip("`").strip()
...
def _format_text_report(
    ...
    lines = [
        "E.M.I.L.Y. — Flight Search Results",
        "─" * 50,
